...
import '../sorts/link_list_sort.dart';
...
class Node {
        ...
        late bool isPlayersTurn; // True if it is the player's turn.
        late bool playerWon; // True if the player won; false if the opponent won.
        late int score;
        late int visitCount;

        

        Node(Node parent, bool isPlayersTurn) {
            this.parent = parent;
            childNodes = [];
